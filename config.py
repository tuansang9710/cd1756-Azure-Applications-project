...
class Config(object):
    ...
    SQL_DATABASE = os.environ.get('SQL_DATABASE') or 'sangtt4-db'
    SQL_USER_NAME = os.environ.get('SQL_USER_NAME') or 'sangtt4'
    ...
    CLIENT_ID = "87600180-6643-4838-81ed-630d3c5cb4aa"
